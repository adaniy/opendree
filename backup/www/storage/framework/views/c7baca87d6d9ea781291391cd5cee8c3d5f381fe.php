...
<?php $__env->startSection('contenu'); ?>
	<div class="col-lg">
	    ...
	    <hr />
		<form id="decal" action="<?php echo e(url('action/ajout')); ?>" method="POST">
			<div class="col-md-6">
				<input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
				<div class="form-group">
					<label for="nom">* Nom de l'action : </label>
					<input type="text" name="nom" class="form-control" value="<?php echo e(old('nom')); ?>" placeholder="Nom de l'action" /><br />
				</div>

				<div class="form-group">
					<label for="date_creation">* Date de création : </label>
					<input type="text" name="date_creation" class="form-control" value="<?php echo e(old('date_creation')); ?>" placeholder="Date de création" /><br />
				</div>
				<div class="form-group">
					<label for="date_butoire">* Date butoire : </label>
					<input type="text" name="date_butoire" class="form-control" value="<?php echo e(old('date_butoire')); ?>" placeholder="Date butoire" />
				</div>
			</div>
			<div class="col-md-6">
				<div class="form-group">
					<label for="date_realisation">Date de réalisation : </label>
					<input type="text" name="date_realisation" class="form-control" value="<?php echo e(old('date_realisation')); ?>" placeholder="Date de réalisation" />
				</div>
				<?php if(old('realise') == 1): ?>
					<div class="radio">
						<label>
				...
				<div class="form-group">
					...
					<input type="numeric" name="alertStart" class="form-control" value="<?php echo e(old('alertStart')); ?>" placeholder="Nombre de jour" />
				</div>

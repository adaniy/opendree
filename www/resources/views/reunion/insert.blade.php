...
@section('contenu')
	<div class="col-lg">
	    ...
	    <hr />
		<form id="decal" action="{{ url('reunion/ajout') }}" method="POST">
			<div class="col-md-12">
				<input type="hidden" name="_token" value="{{ csrf_token() }}">
				<div class="form-group">
					<label for="nom">* Sujet de la réunion :</label>
					<input type="text" name="sujet" class="form-control" value="{{ old('sujet') }}" placeholder="Sujet de la réunion" /><br />
				</div>

				<div class="form-group">
					<label for="nom">* Date et heure de la réunion :</label>
					<input type="text" name="date" class="form-control" value="{{ old('date') }}" placeholder="Date et heure de la réunion" /><br />
				</div>

				<div class="form-group">
					<label for="nom">Date et heure de la prochaine réunion :</label>
					<input type="text" name="date_prochain" class="form-control" value="{{ old('date_prochain') }}" placeholder="Date et heure de la prochaine réunion" /><br />
				</div>
